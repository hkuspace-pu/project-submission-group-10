...
<EasyDataTable
  ...
  <template #item-status="item">
   <div class="pill" :class="item.status == 'Approved' && 'pill_approved', item.status == 'Pending' && 'pill_pending',item.status == 'Denied' && 'pill_denied'">
    {{item.status}}
    </div>
  </template>
...
<table class="dataTable">
  ...
  <tbody>
    ...
    <tr>
      <td>Health tags</td>
      <td><div class="pill" v-for="tag in data.advanced.condition.tags">{{tag}}</div></td>
    </tr>
  </tbody>
</table>
