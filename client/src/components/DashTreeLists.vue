...
const headers = [
      { text: "Scientific Name", value: "scientific_name", sortable: true  },
      { text: "Common Name", value: "common_name", sortable: true },
      { text: "Chinese Name", value: "chinese_name", sortable: true },
      { text: "Family Name", value: "family_name", sortable: true },
      { text: "Native/Exotic Species", value: "native", sortable: true },
    ];
